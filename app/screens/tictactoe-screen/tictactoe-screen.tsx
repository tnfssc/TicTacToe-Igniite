...
export const TictactoeScreen: Component = observer(function TictactoeScreen() {
  ...
  useEffect(() => {
    setTimeout(
      ...
      !stateStore?.ticTacToeState.checkWinner.winner && !stateStore?.ticTacToeState.checkWinner.result
        ? timing.fast
        : timing.instant
    );
    ...
    <Screen style={ROOT} preset="scroll">
      ...
      <Modal
        ...
        <View style={MODAL_VIEW}>
          ...
          <Text style={WINNER_TEXT}>{modalViewState.winner ? modalViewState.winner : 'No one'} wins!</Text>
